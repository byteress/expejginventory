...
use Transfer\Projectors\TransferDetailsProjector;
use Transfer\Projectors\TransferRequestsProjector;
...
return [
    ...
    'reactors' => [
        ...
        \Payment\EventHandlers\ItemDeliveredEventHandler::class
    ],
