<tr x-data="{ edit: false }">
    ...
    <td><span x-show="!edit">{{ $description }}</span> <textarea x-show="edit" wire:model="description" class="form-control" id="details" rows="3" style = "resize:none;"></textarea></td>
    @hasrole('admin')
    ...
    <td>
        ...
        <button x-show="edit" x-on:click="edit = false" type="submit" class="btn btn-success btn-circle btn-sm ml-2">
